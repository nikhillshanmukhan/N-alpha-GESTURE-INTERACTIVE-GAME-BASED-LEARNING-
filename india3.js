...
scene.background = new THREE.Color( 0xb4fff6);
...
*/
//speach
var msg1='one thousand four hundred and one';
            		/* JS comes here */
...
//1-3
var map1 = new THREE.TextureLoader().load( 'https://raw.githubusercontent.com/nikhillshanmukhan/Gesture-Game-icons/47eb881156ba458f903316559885536ca40721da/Numbers%20icons/3.svg' );
...
//2-0
var map2 = new THREE.TextureLoader().load( 'https://raw.githubusercontent.com/nikhillshanmukhan/Gesture-Game-icons/47eb881156ba458f903316559885536ca40721da/Numbers%20icons/0.svg' );
...
handTrack.load(modelParams).then(lmodel => {
 ...
 // updateNote.innerText = "Loaded Model!";
  ...
  if(square3.position.x == -5 && flag==0){
