...
loader.load('https://gist.githubusercontent.com/brettlangdon/85942af486eb79118467/raw/2a7409cd3c26a90b2e82bdc40dc7db18b92b3517/ZAGrhVj.jpg' , function(texture)
            {
...
/*
//1
var map1 = new THREE.TextureLoader().load( 'https://www.flaticon.com/svg/vstatic/svg/773/773228.svg?token=exp=1611648799~hmac=1f340b79f57c40b24ad5b373ecdb3637' );
var material1 = new THREE.SpriteMaterial( { map: map1, color: 0xffffff } );
var pic1 = new THREE.Sprite( material1 );
scene.add(pic1);
pic1.position.x=-6;
*/
...
/*
//2
var map2 = new THREE.TextureLoader().load( 'https://www.flaticon.com/svg/vstatic/svg/3570/3570095.svg?token=exp=1610732185~hmac=39d0d2c6cfb0684a39795ea77ef38ce2' );
...
//3-7
var map3 = new THREE.TextureLoader().load( "https://raw.githubusercontent.com/nikhillshanmukhan/Gesture-Game-icons/47eb881156ba458f903316559885536ca40721da/Numbers%20icons/7.svg" );
...
//4-2
var map4 = new THREE.TextureLoader().load( 'https://raw.githubusercontent.com/nikhillshanmukhan/Gesture-Game-icons/47eb881156ba458f903316559885536ca40721da/Numbers%20icons/2.svg');
...
handTrack.load(modelParams).then(lmodel => {
 ...
 // updateNote.innerText = "Loaded Model!";
  ...
  if(square3.position.x == 2 && flag==0){
